          ...
          {displayedPages > 1 && (
            <>
              <Button
                ...
                className="absolute left-4 bottom-28 sm:left-4 sm:top-1/2 sm:-translate-y-1/2 sm:bottom-auto h-12 w-12 bg-background/90 hover:bg-background shadow-lg z-10"
              ...
              <Button
                ...
                className="absolute right-4 bottom-28 sm:right-4 sm:top-1/2 sm:-translate-y-1/2 sm:bottom-auto h-12 w-12 bg-background/90 hover:bg-background shadow-lg z-10"
