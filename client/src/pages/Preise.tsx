        ...
        <div className="container relative mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed">
              Jährliche Abrechnung – Kreditkarte erforderlich, Abbuchung erst nach 7 Tagen. Jederzeit kündbar.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <Card className="card-premium hover-elevate">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Sie starten mit einer 7-tägigen Testphase – Kreditkarte erforderlich, Abbuchung erst nach 7 Tagen.
                    Wenn Sie innerhalb der Testphase kündigen, entstehen keine Kosten. Nach Ablauf wird das gewählte
                    Jahresabonnement automatisch aktiviert.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="card-premium hover-elevate">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Ja, Sie können Ihr Abonnement jederzeit mit einem Klick kündigen – auch noch während der
                    Testphase, dann entstehen keine Kosten. Bei jährlicher Zahlung endet der Zugang zum Ende des
                    gebuchten Jahres. Es gibt keine versteckten Kosten.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="card-premium hover-elevate">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Wir akzeptieren Kreditkarten (Visa, Mastercard, American Express) und weitere gängige
                    Zahlungsmethoden. Die Abrechnung erfolgt sicher über unseren Zahlungspartner Stripe.
                  </p>
                </CardContent>
              </Card>
